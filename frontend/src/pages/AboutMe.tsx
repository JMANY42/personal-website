        ...
        <div className="flex">
            <div className="p-8 text-white w-1/2">
                ...
                <h2 className="text-3xl font-bold pt-10">What am I passionate about?</h2>
                    <p className="text-xl">I have many interests including autonomous robotics, computer networking, and, in general, how technology interacts with the physical world.</p>
                ...
                <h2 className="text-3xl font-bold pt-10">Am I just a nerd?</h2>
                    <p className="text-xl">No! I am also a cellist in the UTD orchestra and love listening to and playing music. I also love spending time with my wonderful friends.</p>
